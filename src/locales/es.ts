export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      doc: 'Documentos',
      datasetDescription:
        'Por favor, espera a que el análisis del archivo se complete antes de iniciar un chat con IA.',
      ...
      testingDescription: 'Por favor, espera a que el análisis se complete antes de probar',
    ...
    chat: {
      ...
      tokenError: 'Por favor, contacte al administrador para obtener más información',
      searching: 'buscando...',
      parsing: 'Analizando',
      uploading: 'Subiendo',
