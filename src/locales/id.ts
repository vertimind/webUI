export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      doc: 'Dokumen',
      datasetDescription:
        'Silakan tunggu hingga basis pengetahuan berhasil diparsing sebelum bertanya!',
      addFile: 'Tambah file',
      ...
      testingDescription: 'Langkah terakhir! Setelah sukses, biarkan sisanya untuk Kecilin-Team/assistxsuite/ AI.',
    ...
    chat: {
      ...
      tokenError: 'Silakan hubungi administrator untuk informasi lebih lanjut',
      searching: 'mencari...',
      parsing: 'Memparsing',
