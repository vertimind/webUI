export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      doc: 'Tài liệu',
      datasetDescription:
        'Vui lòng chờ đợi cơ sở kiến thức được phân tích cú pháp thành công trước khi hỏi đáp!',
      addFile: 'Thêm tệp',
      ...
      testingDescription: 'Vui lòng chờ phân tích cú pháp thành công trước khi kiểm tra',
...
<i>Các dòng văn bản không tuân theo các quy tắc trên sẽ bị bỏ qua và mỗi cặp sẽ được coi là một đoạn riêng biệt.</i>`,
    ...
    chat: {
      ...
      tokenError: 'Vui lòng liên hệ quản trị viên để tìm hiểu thêm',
